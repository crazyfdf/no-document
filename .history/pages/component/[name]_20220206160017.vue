<template>
  <div class="y-body">
    ...
    <el-table class="y-props" :value="propsData" responsiveLayout="scroll">
      <template #header>
        <h2 class="m-0">Props</h2>
      </template>
      <el-table-column field="name" header="Name"></el-table-column>
      <el-table-column field="type" header="Type"></el-table-column>
      <el-table-column field="description" header="Description"></el-table-column>
      <el-table-column header="Default">
        <template #body="{ data }">
          <div>{{ data.default }}</div>
        </template>
      </el-table-column>
      <el-table-column header="Controls">
        <template #body="{ data }">
          <FormType
            :type="data.type"
            :default="data.default"
            :moreProps="data.moreProps"
