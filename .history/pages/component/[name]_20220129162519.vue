<template>
  <div class="y-body">
    <CodeView :path="componentName" :code="code" :title="displayName">{{ description }}</CodeView>
    <p></p>
    <DataTable :value="tableData" responsiveLayout="scroll">
      ...
      <Column field="controls" header="Controls">
        <template #body>
          <FormType :type="tableData.type"></FormType>
        </template>
      </Column>
    </DataTable>
  </div>
...
import CodeView from "@/plugins/markdown-codeView/code-view";
